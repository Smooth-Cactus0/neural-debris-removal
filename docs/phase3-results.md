...
## Kernel status (as of 2026-06-01 ~22:36 UTC)

| Kernel | Status | Notes |
|--------|--------|-------|
| nb01b (SEED=42) | COMPLETE | 1874 detections, ready to submit |
| nb22 (task-vector negation) | RUNNING | ~60-75 min runtime, 10 combos |

## nb01b — Baseline SEED=42

Exact nb01 + cfg.SEED=42. 20 iters, lr=1e-4, batch=4.
- Test detections: 1874 (nb01 was 1866 — within noise)
- Expected LB: ~223.5 (the published baseline cluster)
- Status: ready to submit (will use 1 of 2 slots tomorrow UTC)
